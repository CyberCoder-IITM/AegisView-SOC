...
export function CompliancePanel() {
  ...
  const handleDownload = () => {
    ...
    window.open(`${baseUrl}/api/compliance/report`, "_blank");
  };
  ...
  return (
    <div className="w-full h-full flex flex-col p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <Button variant="outline" size="sm" onClick={handleDownload} className="h-8 text-xs border-primary/30 text-primary hover:bg-primary/10">
